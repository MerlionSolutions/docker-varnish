sub devicedetect {
	...
	if (req.http.Cookie ~ "(?i)X-UA-Device-force") {
		...
		/* how do we differ between an android phone and an android tablet? http://stackoverflow.com/questions/5341637/how-do-detect-android-tablets-in-general-useragent */
